...
public final class CloudStorageAccount implements CloudClientAccount {
	...
	// private static final String DEFAULT_ENDPOINTS_PROTOCOL_NAME =
	// "DefaultEndpointsProtocol";

	// private static final String DEVELOPMENT_STORAGE_PROXY_URI_NAME =
	...
	// private static final String DEVSTORE_CREDENTIALS_IN_STRING =
	...
	// private static final String USE_DEVELOPMENT_STORAGE_NAME =
	...
	private static String getDefaultQueueEndpoint(
			HashMap<String, String> configuration) {
		String defaultEndpointsProtocol = configuration
				.get("DefaultEndpointsProtocol") == null ? "http"
				: (String) configuration.get("DefaultEndpointsProtocol");
	...
	private static String getDefaultQueueEndpoint(String scheme,
			String accountName) {
		return String.format("%s://%s.%s", new Object[] { scheme, accountName,
