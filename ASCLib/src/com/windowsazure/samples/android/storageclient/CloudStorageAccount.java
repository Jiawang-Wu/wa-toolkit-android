...
public final class CloudStorageAccount implements CloudClientAccount
{
    ...
    public static CloudStorageAccount getDevelopmentStorageAccount(URI uri)
        throws URISyntaxException, IllegalArgumentException, NotImplementedException
    {
        if(uri == null)
        {
        ...
        } else
        {
            ...
            return new CloudStorageAccount(new StorageCredentialsAccountAndKey("devstoreaccount1",
            		"Eby8vdM02xNOcqFlqUwJPLlmEtlCDXJ1OUzFT50uSRZ6IFsuFq2UVErCz4I6tq/K1SZFPTOtr/KBHBeksoGMGw=="),
            		new URI(s.concat(":10000/devstoreaccount1")), new URI(s.concat(":10001/devstoreaccount1")), new URI(s.concat(":10002/devstoreaccount1")));
        }
    }

    public static CloudStorageAccount parse(String s)
        throws URISyntaxException, InvalidKeyException, IllegalArgumentException, NotImplementedException
    {
    ...
    {
        String s = hashmap.get("DefaultEndpointsProtocol") == null ? "http" : (String)hashmap.get("DefaultEndpointsProtocol");
        String s1 = hashmap.get("AccountName") == null ? null : (String)hashmap.get("AccountName");
        ...
        throws URISyntaxException, IllegalArgumentException, NotImplementedException
    {
        if(hashmap.containsKey("UseDevelopmentStorage"))
        {
            ...
            if(hashmap.containsKey("DevelopmentStorageProxyUri"))
                uri = new URI((String)hashmap.get("DevelopmentStorageProxyUri"));
    ...
    private static CloudStorageAccount tryConfigureServiceAccount(HashMap hashmap)
        throws URISyntaxException, InvalidKeyException, IllegalArgumentException, NotImplementedException
    {
        String s = hashmap.get("DefaultEndpointsProtocol") == null ? null : ((String)hashmap.get("DefaultEndpointsProtocol")).toLowerCase();
        if(s != null && !s.equals("http") && !s.equals("https"))
            return null;
        StorageCredentials storagecredentials = StorageCredentials.tryParseCredentials(hashmap);
        URI uri = hashmap.containsKey("BlobEndpoint") ? new URI((String)hashmap.get("BlobEndpoint")) : null;
        URI uri1 = hashmap.containsKey("QueueEndpoint") ? new URI((String)hashmap.get("QueueEndpoint")) : null;
        URI uri2 = hashmap.containsKey("TableEndpoint") ? new URI((String)hashmap.get("TableEndpoint")) : null;
        if(storagecredentials != null)
        {
            if(s != null && hashmap.containsKey("AccountName") && hashmap.containsKey("AccountKey"))
                return new CloudStorageAccount(storagecredentials, uri != null ? uri : new URI(getDefaultBlobEndpoint(hashmap)), uri1 != null ? uri1 : new URI(getDefaultQueueEndpoint(hashmap)), uri2 != null ? uri2 : new URI(getDefaultTableEndpoint(hashmap)));
            if(hashmap.containsKey("BlobEndpoint") || hashmap.containsKey("QueueEndpoint") || hashmap.containsKey("TableEndpoint"))
                return new CloudStorageAccount(storagecredentials, uri, uri1, uri2);
        }
        return null;
    }
        ...
        throws URISyntaxException
    {
        ...
        m_BlobEndpoint = new URI(getDefaultBlobEndpoint("http", m_Credentials.getAccountName()));
        m_QueueEndpoint = new URI(getDefaultQueueEndpoint("http", m_Credentials.getAccountName()));
        m_TableEndpoint = new URI(getDefaultTableEndpoint("http", m_Credentials.getAccountName()));
    }

    public CloudStorageAccount(StorageCredentials storagecredentials, URI uri, URI uri1, URI uri2)
    {
        m_Credentials = storagecredentials;
        m_BlobEndpoint = uri;
    ...
    public CloudStorageAccount(StorageCredentialsAccountAndKey storagecredentialsaccountandkey, Boolean boolean1)
        throws URISyntaxException
    {
        this(((StorageCredentials) (storagecredentialsaccountandkey)), new URI(getDefaultBlobEndpoint(boolean1.booleanValue() ? "https" : "http", storagecredentialsaccountandkey.getAccountName())), new URI(getDefaultQueueEndpoint(boolean1.booleanValue() ? "https" : "http", storagecredentialsaccountandkey.getAccountName())), new URI(getDefaultTableEndpoint(boolean1.booleanValue() ? "https" : "http", storagecredentialsaccountandkey.getAccountName())));
    }
    ...
    {
        if(m_Credentials != null && Utility.isNullOrEmpty(m_Credentials.getAccountName()))
            return m_Credentials.toString(boolean1);
        ArrayList arraylist = new ArrayList();
        if(this == m_devStoreAccount)
            arraylist.add(String.format("%s=true", new Object[] {
                "UseDevelopmentStorage"
            }));
        else
        if(m_Credentials != null && "devstoreaccount1".equals(m_Credentials.getAccountName()) && m_Credentials.toString(Boolean.valueOf(true)).equals("AccountName=devstoreaccount1;AccountKey=Eby8vdM02xNOcqFlqUwJPLlmEtlCDXJ1OUzFT50uSRZ6IFsuFq2UVErCz4I6tq/K1SZFPTOtr/KBHBeksoGMGw==") && m_BlobEndpoint != null && getBlobEndpoint().getHost().equals(getQueueEndpoint().getHost()) && getQueueEndpoint().getHost().equals(getTableEndpoint().getHost()) && getBlobEndpoint().getScheme().equals(getQueueEndpoint().getScheme()) && getQueueEndpoint().getScheme().equals(getTableEndpoint().getScheme()))
        {
            arraylist.add(String.format("%s=true", new Object[] {
                "UseDevelopmentStorage"
            }));
            arraylist.add(String.format("%s=%s://%s", new Object[] {
                "DevelopmentStorageProxyUri", getBlobEndpoint().getScheme(), getBlobEndpoint().getHost()
            }));
        } else
        if(getBlobEndpoint().getHost().endsWith("blob.core.windows.net") && getQueueEndpoint().getHost().endsWith("queue.core.windows.net") && getTableEndpoint().getHost().endsWith("table.core.windows.net") && getBlobEndpoint().getScheme().equals(getQueueEndpoint().getScheme()) && getQueueEndpoint().getScheme().equals(getTableEndpoint().getScheme()))
        {
            arraylist.add(String.format("%s=%s", new Object[] {
                "DefaultEndpointsProtocol", getBlobEndpoint().getScheme()
            }));
