...
final class Base64
{
    ...
    public static String encode(byte abyte0[])
    {
        ...
        for(; j < abyte0.length; j += 3)
        {
            ...
            stringbuilder.append("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((byte)(k >>> 18 & 0x3f)));
            stringbuilder.append("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((byte)(k >>> 12 & 0x3f)));
            stringbuilder.append("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((byte)(k >>> 6 & 0x3f)));
            stringbuilder.append("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((byte)(k & 0x3f)));
        }
    ...
    public static Boolean validateIsBase64String(String s)
    {
        ...
        for(int i = 0; i < s.length(); i++)
        {
            ...
            if(m_Decode64[byte0] == -2)
            {
                if(i < s.length() - 2)
                    return Boolean.valueOf(false);
                if(i == s.length() - 2 && m_Decode64[(byte)s.charAt(i + 1)] != -2)
                    return Boolean.valueOf(false);
            }
