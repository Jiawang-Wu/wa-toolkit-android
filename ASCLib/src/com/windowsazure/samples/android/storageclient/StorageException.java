...
public final class StorageException extends Exception
{
    ...
    protected static StorageExtendedErrorInformation getErrorDetailsFromRequest(HttpResponse response) throws NotImplementedException, UnsupportedEncodingException, IOException
    {
        if(response == null)
        return null;
        StorageErrorResponse storageerrorresponse = new StorageErrorResponse(response.getEntity().getContent());
        return storageerrorresponse.getExtendedErrorInformation();
    }

    public static StorageException translateException(HttpResponse response, Exception exception) throws NotImplementedException, UnsupportedEncodingException, IOException
    {
        if(response == null)
