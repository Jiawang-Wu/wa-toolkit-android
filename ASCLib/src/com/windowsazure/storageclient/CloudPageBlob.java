...
public final class CloudPageBlob extends CloudBlob
{
    ...
    public CloudPageBlob(URI uri, CloudBlobClient cloudblobclient, CloudBlobContainer cloudblobcontainer)
        throws NotImplementedException, StorageException
    {
    	throw new NotImplementedException();
    }
    ...
    public void clearPages(long l, long l1)
    ...
    public void create(long l)
        throws NotImplementedException, StorageException, IllegalArgumentException
    {
    	throw new NotImplementedException();
    }
    ...
    public void uploadPages(InputStream inputstream, long l, long l1)
        throws NotImplementedException, StorageException, IOException, IllegalArgumentException
    {
    	throw new NotImplementedException();
    }
    ...
    private void putPagesInternal(final PageProperties pageProperties, byte abyte0[], final long length, final String leaseID, final String md5)
        throws NotImplementedException, StorageException
    {
    	throw new NotImplementedException();
    }
